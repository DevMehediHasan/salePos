    ...
    <div id="receipt-data">
        <div class="centered">
            <?php if($general_setting->site_logo): ?>
                <img src="<?php echo e(url('logo', $general_setting->site_logo)); ?>" height="42" width="50" style="margin:10px 0;filter: brightness(0);">
            <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\salepro\resources\views/sale/invoice.blade.php ENDPATH**/ ?>